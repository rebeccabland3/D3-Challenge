...
// Y WAS 0 BUT I CHANGED TO 26 below
...
function visualize(data) {
  ...
  var circlesGroup = svg.selectAll("g circlesGroup") // .selectAll() 'g circlesGroup' elements in the svg
            ...
            .attr("cy", d => yScale(d[currentY])) // set the 'cy' .attr() to map from d => yScale() applied to d[currentY]
            ...
            .on('mousover', function(d) { // .on 'mouseover' event, fire off a function that takes argument d
              // Show the tooltip
